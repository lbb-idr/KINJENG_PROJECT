...
包含：
- SectionGenerator mixin: ReACT循环、报告生成、对话
- ReportManager: 报告持久化与检索
- 所有生成相关的 prompt 常量
"""
...
class SectionGenerator:
    """Report Agent 章节生成与 ReACT 循环（mixin）"""
    ...
    def _generate_section_react(
        ...
        # ReACT循环
        tool_calls_count = 0
        max_iterations = 3  # 最大迭代轮数（dari 5 turun ke 3, hemat 40% LLM calls）
